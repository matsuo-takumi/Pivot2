...
namespace Pivot.ViewModels
{
    ...
    public static class TextColorRoleDefinitions
    {
        public static readonly IReadOnlyList<TextColorRoleDefinition> Roles = new[]
        {
            ...
            new TextColorRoleDefinition("Text.App.Body", "App Body Text", "Body copy in lists and cards.", Microsoft.UI.ColorHelper.FromArgb(255, 68, 68, 68), "AppTextBodyBrush"),
            new TextColorRoleDefinition("Text.App.Secondary", "App Secondary Text", "Explanatory or helper copy inside panels.", Microsoft.UI.ColorHelper.FromArgb(255, 102, 102, 102), "AppTextSecondaryBrush"),
            new TextColorRoleDefinition("Text.App.Caption", "App Caption Text", "Small labels and status lines.", Microsoft.UI.ColorHelper.FromArgb(255, 90, 90, 90), "AppTextCaptionBrush"),
            new TextColorRoleDefinition("Text.App.Muted", "App Muted Text", "Metadata and tertiary values.", Microsoft.UI.ColorHelper.FromArgb(255, 85, 85, 85), "AppTextMutedBrush"),
            new TextColorRoleDefinition("Text.App.Dim", "App Dim Text", "Placeholder text and hints.", Microsoft.UI.ColorHelper.FromArgb(255, 119, 119, 119), "AppTextDimBrush"),
            new TextColorRoleDefinition("Text.App.Accent", "App Accent Text", "Linky accents and glyphs.", Microsoft.UI.ColorHelper.FromArgb(255, 0, 120, 212), "AppTextAccentBrush"),
            new TextColorRoleDefinition("Text.App.AccentDim", "App Accent Dim", "Less prominent accent glyphs.", Microsoft.UI.ColorHelper.FromArgb(255, 138, 138, 138), "AppTextAccentDimBrush"),
